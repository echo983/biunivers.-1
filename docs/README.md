...
| 文档 | 状态 | 内容 |
|---|---|---|
| [V0.10 目录 ZIP 导出设计](<浏览器云端个人桌面 V0.10 目录 ZIP 导出设计.md>) | 已实现 | 复用下载按钮、internal 快照、流式 ZIP Store、进度、取消与安全边界 |
| [V0.10 目录 ZIP 导出施工计划](<浏览器云端个人桌面 V0.10 目录 ZIP 导出施工计划.md>) | 待真实验收 | ZIP 核心、快照服务、HTTP、文件管理器集成和真实验收 |
| [V0.10 目录 ZIP 导出验收](<acceptance/V0.10 目录 ZIP 导出验收.md>) | 自动验证通过 | 自动化证据与真实 Docker/R2 浏览器验收清单 |
