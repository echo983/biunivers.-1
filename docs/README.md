...
| 文档 | 状态 | 内容 |
|---|---|---|
| [V0.10 目录 ZIP 导出设计](<浏览器云端个人桌面 V0.10 目录 ZIP 导出设计.md>) | 设计基线 | 复用下载按钮、internal 快照、流式 ZIP Store、进度、取消与安全边界 |
| [V0.10 目录 ZIP 导出施工计划](<浏览器云端个人桌面 V0.10 目录 ZIP 导出施工计划.md>) | 待施工 | ZIP 核心、快照服务、HTTP、文件管理器集成和真实验收 |
